...
Cable-actuated damper (f.e. Jotul i570 fresh-air intake), servo-driven, 40mm
...
- 🔵 lighting_up (from HA via `MQTT_TOPIC_PHASE`)
- 🟡 estinguishing (from HA via `MQTT_TOPIC_PHASE`)
